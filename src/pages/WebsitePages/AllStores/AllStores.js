...
const HeroSection = ({ defaultState, setDefaultState, setUsers }) => {
    ...
    const getAllStores = async (values) => {
        setIsLoading(true);
        try {
            const { data } = await axios.get(`/user/getStore?page=${values?.page? values?.page : currentPage}&pageSize=9&sort=${values?.sort ? values?.sort : sortSelected}`);
...
// {(allStoresData.totalDocs%2===0) ? (
//     <>
//         {[...Array(allStoresData.totalDocs/2).keys()].map((item,index) => (
//             <>
//                 <PageButton IsSelectedPage={true}>
//                     {item+1}
//                 </PageButton>
//             </>
//         ))}
...
//             <>
//                 <PageButton IsSelectedPage={true}>
//                     {allStoresData.totalDocs/2+item+1}
//                 </PageButton>
//             </>
//         ))}
//     </>

              ...
              <div className="orderhead">
                ...
                <div>
                  <h6 className="Cancel-status">
                    <DeliveredTime orderData={orderData} />
                  </h6>
                </div>
              </div>
                ...
                <div className="row justify-content-between">
                  ...
                  <div className="col-6 leftside">
                    <div>
                      <div className="d-flex">
                        <Locationicon />
                        <h6 className="ps-2 bold">Delivery Address :</h6>
                      </div>
                      <div>
                        <p>
                ...
                <div className="ordertrack mt-3">
                  <div className="order-tracking">
                    ...
                    <div className="status-list">
                      <div className="status-item d-flex w-25">
                      ...
                      <div className="d-flex orderstt w-30 justify-content-between">
                        <div>
                          <p className="bold">orderPlaced</p>
                        </div>
                        <div>
...
export default Order_delivered;
...
const DeliveredTime = (orderData) => {
  const dateString = orderData?.orderData?.orderStatus?.delivered?.date;
  const date = new Date(dateString);
  const options = {
    year: "numeric",
    month: "long",
  ...
  return (
    <>
      <h4 className="pt-3 text-red">Dilivered on &nbsp; {formattedDate}</h4>
    </>
  );
};
